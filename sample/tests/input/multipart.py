...
def main():
    #filename = os.getcwd() + "/data-multipart-form-data-partial-chrome.txt"
    filename = os.getcwd() + "/data-multipart-form-data-chrome.txt"
    filesize = os.path.getsize(filename)
    with open(filename) as f:
        #content_type = "multipart/form-data; boundary=------WebKitFormBoundary78HZzKC8B5zSLtAb"
        ...
        print(machine.files)
        #print(machine.files["photo2"])
        #image = open(os.getcwd() + "/photo2","wb")
        #image.write(machine.files["photo2"][0]["data"].read())
